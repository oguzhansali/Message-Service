package com.messagingservice.core.config;

import com.messagingservice.core.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleUserAlreadyBlockedException(UserAlreadyBlockedException ex){
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(ex.getMessage());
    }

    @ExceptionHandler(UserCannotBlockThemselfException.class)
    public ResponseEntity<String> handleUserCannotBlockThemselfException(UserCannotBlockThemselfException ex){
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(ex.getMessage());
    }
